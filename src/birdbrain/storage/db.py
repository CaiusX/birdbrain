...
class Database:
    ...
    # birdbrain.audio_hash at insert time (and backfilled via
    # `birdbrain dedup-backfill`). Rows with NULL hash are NEVER flagged as
